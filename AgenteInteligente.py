...
class ResultDatabase:
    ...
    # cargar resultados de la base de datos
...
class GeneticAlgorithm:
    ...
    def __init__(self, graph, graphIE, graphIS, start_node, end_node, population_size, generations):
        ...
        self.result_db = ResultDatabase()
    # inicialización de la poblacion del algoritmo genetico
    ...
    # Seleccion de la población para realizar los cruces
    def select(self):
        ...
        for individual in self.population:
            ...
            if current > pick:
                return individual
    # Proceso de cruce entre dos individuos
    def crossover(self, parent1, parent2):
        ...
        return child
    # Función para validar rutas y evitar rutas erroneas
    ...
    # Población combinada entre rutas iniciales y población actual
    def select_from_combined(self, combined_population):
        total_fitness = sum(1 / (self.fitness(individual)[0] + 1e-6) for individual in combined_population) #EPSILON para evitar división por cero
        ...
        for individual in combined_population:
            ...
            if current > pick:
                return individual
    # Añadir las interfaces a las rutas calculadas
    ...
    # Obtener la ruta más adecuada para la interfaz de entrada
    def run(self):
...
# proceso del Agente Inteligente
def main():
